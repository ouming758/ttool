...
public class DateUtils {
	 ...
	 *            StrUtils.PATTERN_DATE，如果为空，则为yyyy-MM-dd
	 * @return
	 * @throws ParseException
	 */
	...
	public static void main(String[] args) throws Exception {
		System.out.println("格式化1:" + dateTimeToDateStringIfTimeEndZero(new Date()));
		System.out.println("格式化2:" + dateTimeToDateStringIfTimeEndZero(dateTimeToDate(new Date())));
		System.out.println("相差天数(包含今天):"
				+ dateBetween(dateParse("2017-01-30", null), dateParse("2017-02-01", null), true));
		System.out.println("相差天数(不含今天):" + dateBetween(dateParse("2017-01-30", null), dateParse("2017-02-01", null)));
